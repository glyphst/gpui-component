...
impl InputState {
    ...
    fn request_menu_completions(
        ...
        self.lsp.completion_menu = provider.completion_menu_options();
    ...
    pub(crate) fn hide_context_menu(&mut self, cx: &mut Context<Self>) {
        ...
        self.context_menu_content.completion.trigger_start_offset = None;
        self.context_menu_content.completion.query.clear();
        self.context_menu_content.completion.items.clear();
        ...
        if handled && closes_overlay {
            match kind {
                super::InputOverlayKind::Completion => {
                    let completion = &mut self.context_menu_content.completion;
                    completion.open = false;
                    completion.trigger_start_offset = None;
